...
const translations: Translations = {
	en: {
		...
		"menu.stats": "My Stats",
		"menu.purchaseShield": "Purchase Shield",
		...
		"menu.noMyGames":
			'You haven\'t created any games yet.<br>Click "Create Game" to start!',
		"menu.noCommunityGames":
			"No community games available yet.<br>Be the first to publish one!",
		...
		"game.quizCorrect": "Correct! Well done!",
		"game.quizWrong": "Wrong answer! Try again!",
		"game.speedUp": "SPEED UP! (20s)",
		"game.gotIt": "✓ Got it!",
		"game.howToPlayTitle": "🎮 How to Play",
		"game.controlsList":
			"<li><strong>Arrow Keys</strong> - Move your player around the border</li><li><strong>↑ Up</strong> - Move up</li><li><strong>↓ Down</strong> - Move down</li><li><strong>← Left</strong> - Move left</li><li><strong>→ Right</strong> - Move right</li>",
		"game.objectiveText":
			'Claim territory by drawing lines across the playing field. Fill up <strong style="color: #FFD700;">75%</strong> or more of the area to reveal the hidden image and advance to the next level!',
		"game.rulesList":
			"<li>You can only move along the <strong>border</strong> or <strong>claimed areas</strong></li><li>When you venture into unclaimed territory, you draw a line</li><li>Complete a shape by returning to claimed territory to fill it in</li><li>The area without enemies gets filled!</li>",
		"game.dangersList":
			'<li><strong style="color: #FF6B6B;">Qix</strong> - The bouncing enemy in the center. Don\'t let it touch your line while drawing!</li><li><strong style="color: #FF6B6B;">Sparky</strong> - Enemies that patrol the borders. Avoid them!</li><li>If hit, you lose a life and restart the level</li>',
		"game.tipsList":
			"<li>Draw quickly to minimize risk</li><li>Claim smaller areas at first for safety</li><li>Watch enemy patterns before making your move</li><li>Larger claims give more area percentage!</li>",
		...
		"login.userNotFound":
			"User not found. Click Register to create an account.",
	...
	jp: {
		...
		"menu.noMyGames":
			"まだゲームを作成していません。<br>「ゲーム作成」をクリックして始めましょう！",
		"menu.noCommunityGames":
			"コミュニティゲームはまだありません。<br>最初のゲームを公開しましょう！",
		"menu.published": "公開中",
		"menu.draft": "下書き",
		...
		"game.quizCorrect": "正解！よくできました！",
		"game.quizWrong": "不正解！もう一度！",
		"game.speedUp": "スピードアップ！ (20秒)",
		"game.gotIt": "✓ 分かった！",
		"game.howToPlayTitle": "🎮 遊び方",
		"game.controlsList":
			"<li><strong>矢印キー</strong> - プレイヤーを移動</li><li><strong>↑ 上</strong> - 上へ移動</li><li><strong>↓ 下</strong> - 下へ移動</li><li><strong>← 左</strong> - 左へ移動</li><li><strong>→ 右</strong> - 右へ移動</li>",
		"game.objectiveText":
			'線を引いて陣地を広げましょう。<strong style="color: #FFD700;">75%</strong> 以上のエリアを埋めると、隠された画像が現れて次のレベルに進めます！',
		"game.rulesList":
			"<li><strong>境界線</strong>や<strong>自分の陣地</strong>の上だけ移動できます</li><li>未開拓のエリアに入ると線を引きます</li><li>自分の陣地に戻ると、囲んだエリアが埋まります</li><li>敵がいない方のエリアが埋まります！</li>",
		"game.dangersList":
			'<li><strong style="color: #FF6B6B;">Qix (クイックス)</strong> - 中央を跳ね回る敵。線を引いている最中に触れないように！</li><li><strong style="color: #FF6B6B;">Sparky (スパーキー)</strong> - 境界線を巡回する敵。避けましょう！</li><li>当たるとライフを失い、レベルの最初からやり直しです</li>',
		"game.tipsList":
			"<li>素早く線を引いてリスクを減らしましょう</li><li>最初は小さなエリアから確保するのが安全です</li><li>敵の動きをよく見てから動き出しましょう</li><li>大きく囲めば獲得率もアップ！</li>",
		...
		"create.noLevels":
			"レベルがありません。<br>ポケモンを検索して追加してください",
		...
		"login.userNotFound":
			"ユーザーが見つかりません。登録ボタンからアカウントを作成してください。",
	...
	cn: {
		...
		"game.speedUp": "加速！ (20秒)",
		"game.quizTime": "问答时间！",
		"game.quizCorrect": "回答正确！干得好！",
		"game.quizWrong": "回答错误！再试一次！",
		"game.gotIt": "✓ 明白了！",
		"game.howToPlayTitle": "🎮 游戏说明",
		"game.controlsList":
			"<li><strong>方向键</strong> - 沿边界移动</li><li><strong>↑ 上</strong> - 向上移动</li><li><strong>↓ 下</strong> - 向下移动</li><li><strong>← 左</strong> - 向左移动</li><li><strong>→ 右</strong> - 向右移动</li>",
		"game.objectiveText":
			'通过画线圈地来占领区域。填满 <strong style="color: #FFD700;">75%</strong> 或更多区域以显示隐藏图像并进入下一关！',
		"game.rulesList":
			"<li>你只能在<strong>边界</strong>或<strong>已占领区域</strong>上移动</li><li>当你进入未占领区域时，会画出一条线</li><li>回到已占领区域以闭合形状并填充它</li><li>没有敌人的区域会被填充！</li>",
		"game.dangersList":
			'<li><strong style="color: #FF6B6B;">Qix</strong> - 在中心弹跳的敌人。画线时不要让它碰到你的线！</li><li><strong style="color: #FF6B6B;">Sparky</strong> - 沿边界巡逻的敌人。避开它们！</li><li>如果被击中，你会失去一条生命并重新开始本关</li>',
		"game.tipsList":
			"<li>快速画线以降低风险</li><li>先占领小区域以确保安全</li><li>观察敌人模式后再行动</li><li>一次圈更大的区域可以获得更多百分比！</li>",
...
export class I18nService {
	...
	static init() {
		...
		if (
			savedLang &&
			(savedLang === "en" || savedLang === "jp" || savedLang === "cn")
		) {
			I18nService.currentLang = savedLang;
		} else {
			// Detect browser language
			const browserLang = navigator.language;
			if (browserLang.startsWith("ja")) {
				I18nService.currentLang = "jp";
			} else if (browserLang.startsWith("zh")) {
				I18nService.currentLang = "cn";
			} else {
				I18nService.currentLang = "en";
			}
		}

		I18nService.applyLangToDOM();
		logger.log(`[I18n] Initialized with language: ${I18nService.currentLang}`);
	}
	...
	static toggleLang() {
		if (I18nService.currentLang === "en") {
			I18nService.setLang("jp");
		} else if (I18nService.currentLang === "jp") {
			I18nService.setLang("cn");
		} else {
	...
	static t(key: string, ...args: any[]): string {
		const dict = translations[I18nService.currentLang];
	...
	static onChange(callback: () => void) {
		I18nService.listeners.push(callback);
	}

	private static notifyListeners() {
		I18nService.listeners.forEach((callback) => {
			callback();
		});
	}
}
